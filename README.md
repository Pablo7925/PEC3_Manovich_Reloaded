...
- Uso intensivo de escenas cinemáticas, diálogos escritos al modo de guiones de cine y puesta en escena realista.
...
Según Manovich se podría decir que el vídeo juego es un metamedio que contiene secuencias de vídeo, espacios 3D, musica interactiva, interfaz gráfica, la hibridación ya no es "meter un vídeo" en el juego, sino integrar las operaciones propias del lenguaje cinematográfico (plano, montaje, actuación).
...
Aquí, la hibridación no es solo "poner un juego" dentro del aula, sino desdibujar la frontera entre gestión educativa, red social y videojuego. La lógica de cada medio se filtra en los otros:
- Lógica de la red socia
